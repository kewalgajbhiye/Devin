...
class SalesReportsForm:
    ...
    def create_report_section(self, parent):
        ...
        report_frame = ttk.LabelFrame(parent, text="Sales Summary", padding=10)
        ...
        scrollbar = ttk.Scrollbar(report_frame, orient='vertical', command=self.sales_tree.yview)
    ...
    def load_sales_data(self):
        ...
        try:
            ...
            for bill_no in range(1, random.randint(12, 20)):
                random_days = random.randint(0, (end_date - start_date).days)
                bill_date = start_date + timedelta(days=random_days)
                
                party = random.choice(parties)
                num_items = random.randint(1, 4)
                bill_amount = random.randint(3000, 40000)
            ...
            self.main_app.update_status(f"Sales report loaded: {bill_count} bills")
    ...
    def print_report(self):
        ...
        try:
            ...
            print_window.title("Sales Report - Print Preview")
    ...
    def export_report(self):
        ...
        try:
            ...
            ExportUtils.export_to_excel(data, headers, "sales_report", "Sales Report")
    ...
    def generate_report_text(self):
        ...
        lines = []
        lines.append("=" * 90)
        lines.append("SALES REPORT".center(90))
        lines.append("=" * 90)
    ...
    def export_to_csv(self):
        ...
        try:
            ...
            ExportUtils.export_to_csv(data, headers, "sales_report")
